<div class="usernav">
    ...
    <ul> <!-- Ensure there are no enter escape characters.-->
        <li><a href="requests.php">Friend Requests (<?php echo $row['count'] ?>)</a></li><li><a href="../view/profile.php">Profile</a></li><li><a href="../view/friends.php">Friends</a></li><li><a href="../view/home.php">Home</a></li><li><a href="../view/logout.php">Log Out</a></li>
